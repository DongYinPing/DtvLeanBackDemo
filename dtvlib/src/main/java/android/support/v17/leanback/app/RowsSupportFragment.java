...
*/
    ...
    private int mSelectedRowPosition = 0;//TODO DYP
    @Override
        ...
        if (mSelectedViewHolder != viewHolder || mSubPosition != subposition) {
            ...
            if (mSelectedViewHolder != null) {
               setRowViewSelected(mSelectedViewHolder, false, false);
                /*if(position > mSelectedViewHolder.getAdapterPosition()) {
                    mSelectedViewHolder.itemView.setAlpha(0.0f);
                } else {
