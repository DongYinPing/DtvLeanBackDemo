...
final class GridLayoutManager extends RecyclerView.LayoutManager {
    ...
    /**
     * Set the column width. May be WRAP_CONTENT, or a size in pixels.
     */
    public void setColumnWidth(int width) {
        if (width >= 0 || width == ViewGroup.LayoutParams.WRAP_CONTENT) {
            mRowSizeSecondaryRequested = width;
        } else {
            throw new IllegalArgumentException("Invalid row width: " + width);
        }
    }
