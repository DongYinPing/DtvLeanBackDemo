 ...
 * the License.
 */
package com.dtv.leanback.fragment.row;
...
import com.dtv.leanback.fragment.row.adapter.ObjectAdapter;
import com.dtv.leanback.fragment.row.listener.BaseOnItemViewClickedListener;
import com.dtv.leanback.fragment.row.listener.BaseOnItemViewSelectedListener;
import com.dtv.leanback.fragment.row.presenter.ListRowPresenter;
import com.dtv.leanback.fragment.row.presenter.Presenter;
import com.dtv.leanback.fragment.row.presenter.PresenterSelector;
...
import com.dtv.leanback.widget.gridview.ViewHolderTask;
...
*/
    ...
    void onRowSelected(RecyclerView parent, RecyclerView.ViewHolder viewHolder,
        ...
        if (mSelectedViewHolder != viewHolder || mSubPosition != subposition) {
            ...
            if (mSelectedViewHolder != null) {
                //mSelectedViewHolder.itemView.setAlpha(1.0f);
                setRowViewSelected(mSelectedViewHolder, true, true);
            }
    ...
    */
    ...
    public void setAlignmentPercent(int windowAlignOffsetPercentFromTop) {
        if (windowAlignOffsetPercentFromTop == ALIGN_TOP_NOT_SET) {
            return;
        }
        mAlignedTop = 0;
        final VerticalGridView gridView = getVerticalGridView();
        ...
        if (gridView != null) {
            ...
            gridView.setWindowAlignmentOffset(mAlignedTop);
            // align to a fixed position from top
            gridView.setWindowAlignmentOffsetPercent(windowAlignOffsetPercentFromTop);
