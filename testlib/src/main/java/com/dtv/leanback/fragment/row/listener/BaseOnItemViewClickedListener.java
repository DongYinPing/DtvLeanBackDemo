 ...
 * the License.
 */
package com.dtv.leanback.fragment.row.listener;
...
public interface BaseOnItemViewClickedListener<T> {
     ...
     */
    void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, T row);
}
