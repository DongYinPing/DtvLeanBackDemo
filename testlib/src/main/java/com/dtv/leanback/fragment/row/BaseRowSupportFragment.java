...
import com.dtv.leanback.widget.gridview.OnChildViewHolderSelectedListener;
...
abstract class BaseRowSupportFragment extends Fragment {
    ...
    abstract int getLayoutResourceId();//子类传递layoutid
    ...
    public void setAlignment(int windowAlignOffsetTop) {
        if (mVerticalGridView != null) {
            ...
            //
            mVerticalGridView.setItemAlignmentOffsetWithPadding(true);
