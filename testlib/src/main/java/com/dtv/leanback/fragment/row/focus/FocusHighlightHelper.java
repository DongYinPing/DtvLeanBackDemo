 ...
 * the License.
 */
package com.dtv.leanback.fragment.row.focus;
...
import com.dtv.leanback.fragment.row.dimmer.ColorOverlayDimmer;
import com.dtv.leanback.fragment.row.presenter.ListRowPresenter;
import com.dtv.leanback.fragment.row.presenter.Presenter;
import com.dtv.leanback.fragment.row.presenter.RowHeaderPresenter;
import com.dtv.leanback.fragment.row.shadow.ShadowOverlayContainer;
import com.dtv.leanback.fragment.row.shadow.ShadowOverlayHelper;
import com.dtv.leanback.widget.gridview.VerticalGridView;

import static com.dtv.leanback.fragment.row.focus.FocusHighlight.ZOOM_FACTOR_LARGE;
import static com.dtv.leanback.fragment.row.focus.FocusHighlight.ZOOM_FACTOR_MEDIUM;
import static com.dtv.leanback.fragment.row.focus.FocusHighlight.ZOOM_FACTOR_NONE;
import static com.dtv.leanback.fragment.row.focus.FocusHighlight.ZOOM_FACTOR_SMALL;
import static com.dtv.leanback.fragment.row.focus.FocusHighlight.ZOOM_FACTOR_XSMALL;
    ...
    static class HeaderItemFocusHighlight implements FocusHighlightHandler {
        ...
        void lazyInit(View view) {
            if (!mInitialized) {
                ...
                mSelectScale = mScaleEnabled ? Float.parseFloat(res.getString(R.dimen.lb_browse_header_select_scale)): 1f;
                mDuration = Integer.parseInt(res.getString(R.dimen.lb_browse_header_select_duration));
                mInitialized = true;
            }
        }
