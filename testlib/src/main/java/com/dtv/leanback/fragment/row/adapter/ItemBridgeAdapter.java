 ...
 * the License.
 */
package com.dtv.leanback.fragment.row.adapter;
...
import com.dtv.leanback.fragment.row.focus.FocusHighlightHandler;
import com.dtv.leanback.fragment.row.presenter.Presenter;
import com.dtv.leanback.fragment.row.presenter.PresenterSelector;

import com.dtv.leanback.widget.gridview.FacetProvider;
import com.dtv.leanback.widget.gridview.FacetProviderAdapter;
...
public class ItemBridgeAdapter extends RecyclerView.Adapter implements FacetProviderAdapter {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements FacetProvider {
        ...
        public final OnFocusChangeListener mFocusChangeListener = new OnFocusChangeListener();
        public Object mItem;
