...
package com.google.leanback.model;

import java.util.ArrayList;
import java.util.List;

public final class MovieList {
    public static final String Item_CATEGORY[] = {"Category Zero", "Category One", "Category Two", "Category Three", "Category Four", "Category Five",};
    ...
    public static List<Item> setupItems() {
        list = new ArrayList<>();
        ...
        for (int index = 0; index < title.length; ++index) {
            list.add(buildItemInfo(title[index], description, studio[index], videoUrl[index], cardImageUrl[index], bgImageUrl[index]));
        }

        return list;
    }

    private static Item buildItemInfo(String title, String description, String studio, String videoUrl, String cardImageUrl, String backgroundImageUrl) {
        Item Item = new Item();
        Item.setId(count++);
        Item.setTitle(title);
        ...
        Item.setBackgroundImageUrl(backgroundImageUrl);
